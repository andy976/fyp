...
/*function update_bar1(cont,height,color,index)
{
    var cont_temp = cont;
    cont_temp.innerHTML = "<div align=\"center\"><font color = white>" + height + "</font></div>";
    cont_temp.style=" margin:0% " + margin_size + "%; width:" + (100/array_size-(2*margin_size)) + "%; height:" + height + "%; background-color:" + color + ";";
    ...
    if (action_count == 0) {
        for (var i = 0; i < array_size; i++) {
            array_style1[(action_count*array_size)+i] = numberbar1[i].style.cssText;
            array_innerHTML1[(action_count*array_size)+i] = numberbar1[i].innerHTML;
        ...
        for (var i = 0; i < array_size; i++) {
            array_style1[(action_count*array_size)+i] = array_style1[((action_count-1)*array_size)+i];
            array_innerHTML1[(action_count*array_size)+i] = array_innerHTML1[((action_count-1)*array_size)+i];
    ...
    array_style1[(action_count*array_size)+index] = " margin:0% " + margin_size + "%; width:" + (100/array_size-(2*margin_size)) + "%; height:" + height + "%; background-color:" + color + ";";
    array_innerHTML1[(action_count*array_size)+index] = "<div align=\"center\"><font color = white>" + height + "</font></div>";

    manual_action1[action_count] = cont_temp;
    manual_action_index1[action_count] = index;
    //console.log(action_count);
    action_count1 = action_count1 + 1;
}

function update_bar2(cont,height,color,index)
{
    var cont_temp = cont;
    cont_temp.innerHTML = "<div align=\"center\"><font color = white>" + height + "</font></div>";
    cont_temp.style=" margin:0% " + margin_size + "%; width:" + (100/array_size-(2*margin_size)) + "%; height:" + height + "%; background-color:" + color + ";";
    ...
    if (action_count == 0) {
        for (var i = 0; i < array_size; i++) {
            array_style2[(action_count*array_size)+i] = numberbar2[i].style.cssText;
            array_innerHTML2[(action_count*array_size)+i] = numberbar2[i].innerHTML;
            //console.log(action_count, "AAA", i);
            //console.log(array_style[(action_count+1)*i]);
            //console.log(array_innerHTML[(action_count+1)*i]);
        }
        ...
        for (var i = 0; i < array_size; i++) {
            array_style2[(action_count*array_size)+i] = array_style2[((action_count-1)*array_size)+i];
            array_innerHTML2[(action_count*array_size)+i] = array_innerHTML2[((action_count-1)*array_size)+i];
            //console.log((action_count), "BBB", i);
            //console.log(array_style[(action_count+1)*i]);
            //console.log(array_innerHTML[(action_count+1)*i]);
            //console.log(array_style[action_count, i]);
    ...
    array_style2[(action_count*array_size)+index] = " margin:0% " + margin_size + "%; width:" + (100/array_size-(2*margin_size)) + "%; height:" + height + "%; background-color:" + color + ";";
    array_innerHTML2[(action_count*array_size)+index] = "<div align=\"center\"><font color = white>" + height + "</font></div>";

    manual_action2[action_count] = cont_temp;
    manual_action_index2[action_count] = index;
    //console.log(action_count);
    action_count2 = action_count2 + 1;
}*/
